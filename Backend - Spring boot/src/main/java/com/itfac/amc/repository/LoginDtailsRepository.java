...
public interface LoginDtailsRepository extends JpaRepository<LoginDetails, Integer> {
	...
	@Query(value = "Select u.user_id, u.uname, ld.loged_ip, ld.loged_datetime, ld.logout_ip,ld.logout_datetime from user u, login_details ld where u.user_id = ld.user_id  ORDER BY loged_datetime DESC" , nativeQuery = true)
